...
plt2 <- ggplot() + 
  geom_bar(aes(x=as.Date(dPCR_HV6970del$date),
               y=-log(dPCR_HV6970del[,1]/apply(dPCR_HV6970del[,1:3], 1, sum)) / 0.0005477004196028817 * 8 / 2,
               fill="SARS-CoV-2"),
           stat="identity") + 
  geom_bar(aes(x=as.Date(dPCR_HV6970del$date),
...
plt2 <- ggplot() + 
  geom_bar(aes(x=as.Date(dPCR_Orf1adel$date),
               y=-log(dPCR_Orf1adel[,1]/apply(dPCR_Orf1adel[,1:3], 1, sum)) / 0.0005477004196028817 * 8 / 2
               # fill="SARS-CoV-2"
               ),
           stat="identity",
           fill="grey") + 
...
plt2 <- ggplot() + 
  geom_bar(aes(x=as.Date(dPCR_HV6970del$date),
           ...
           stat="identity") + 
  geom_bar(aes(x=as.Date(dPCR_HV6970del$date),
               y=dPCR_HV6970del_empirical_freqs*-log(dPCR_HV6970del[,1]/apply(dPCR_HV6970del[,1:3], 1, sum)) / 0.0005477004196028817 * 8 / 2 ,
               fill="dPCR HV6970 del"),
           stat="identity") + 
    xlab("date") + ylab("gc/ml") +
  guides(fill=FALSE) +
...
plt2 <- ggplot() + 
  geom_bar(aes(x=as.Date(dPCR_Orf1adel$date),
           ...
           fill="grey") + 
  geom_bar(aes(x=as.Date(dPCR_Orf1adel$date),
               y=dPCR_Orf1a_empirical_freqs*-log(dPCR_Orf1adel[,1]/apply(dPCR_Orf1adel[,1:3], 1, sum)) / 0.0005477004196028817 * 8 / 2,
               fill="dPCR ORF1a del"),
           stat="identity") + 
    xlab("date") + ylab("gc/ml") + guides(fill=FALSE) +
  theme_classic() +
