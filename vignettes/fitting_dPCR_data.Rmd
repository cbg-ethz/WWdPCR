...
In this document, we show how the likelihood model for duplex dPCR assays derived in Caduff et al. 2021 [(doi.org/10.1101/2021.08.22.21262024)](doi.org/10.1101/2021.08.22.21262024) can be used to compute confidence intervals for individual measurements, as well as fitting logistic growth curves and inferring growth rates for time series data. The logistic growth here starts with a >0 background prevalence. 
...
We will use wastewater RT-ddPCR data from Caduff et. al. [(doi.org/10.1101/2021.08.22.21262024)](doi.org/10.1101/2021.08.22.21262024). The assay targets SARS-CoV-2 S-gene HV69-70 deletion, a signature of the B.1.1.7 (Alpha) variant. However, the deletion is also present in other lineages, and thus has a background prevalence. In the attached dataset, x0 x1 and x2 are the counts of double negative, single positive and double positive droplets, respectively. 
...
We can compare it to a fit on the number of clinical B.1.1.7 cases. The data from Swiss clinical sequencing is attached, and was obtained from [Cov-Spectrum](https://cov-spectrum.ethz.ch/).
